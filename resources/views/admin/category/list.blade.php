                            ...
                            <table class="data-table" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" data-id="{{$val->id}}" data-name="{{$val->name}}" data-parent-category="{{$val->parent_category_id}}" data-ar_name="{{$val->ar_name}}" class="edit_cls btn btn-success text-white">{{__('messages.edit_title')}}</a>
