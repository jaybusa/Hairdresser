...
class OrderControllerBK extends Controller
{
    ...
    public function order_complete(Request $request) {
        ...
        if($payment_method==1) {
            ...
            // $description = '';
            // if($due_amount>0) {
            //     $description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount;
            // } else {
            //     $description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount;
            // }
            ...
            $description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Order amount='.$order_amount.', Payment Type=Cash Payment';
            ...
            // no payment
            $description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount.', Payment Type=No Payment';

            // hairdressor wallet update
            //$description = 'Hairdresser amount='.$hairdressor_amount;
            //$description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount;
            ...
            // customer wallet update
                ...
                //$description = 'Hairdresser amount='.$hairdressor_amount.',Admin amount='.$admin_amount;
                //$description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount;
            ...
            // card payment
            /*$description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount.', Payment Type=Card Payment';
            // hairdressor wallet update
            //$description = 'Hairdresser amount='.$hairdressor_amount;
            //$description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount;
    ...
    public function order_payment(Request $request) {
        ...
        $description = 'Admin amount='.$admin_amount.', Hairdresser amount='.$hairdressor_amount.', Commision Amount='.$commision_amount.', Tax amount='.$tax_amount.', Due amount='.$due_amount.', amount='.$amount.', Payment Type=Online Payment';
